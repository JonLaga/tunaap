...
class FishingSession {
  ...
  // Getter para obtener el asset dinámico basado en la configuración
  String get currentRodAsset => 'assets/images/fishing/rods_$rodCount.png';
  ...
  factory FishingSession.fromMap(Map<String, dynamic> map) {
    return FishingSession(
      ...
      canas: List<Rod>.from(
        (map['canas'] as List<dynamic>? ?? []).map((x) => Rod.fromMap(x as Map<String, dynamic>)),
      ),
    );
  }
}